...
(function($){
    $.fn.socialLinkBuilder = function(opts){
        ...
        if(opts.facebook.isUsed){
            ...
            var baseUrl = document.location.origin+window.location.pathname;
            var title = $('.showSocial').find(".titleSec h4").text();
            var discrip = $('.showSocial').find(".discription p").text();
            var pic = $('.showSocial').find(".imgSec img").attr("src").split("?")[0];
            var fbsvg = '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0" y="0" viewBox="0 0 470.5 470.5" xml:space="preserve" fill="rgb(0, 0, 0)"><style>.s0{fill:rgb(0, 0, 0);}</style><path d="M271.5 154.2v-40.5c0-6.1 0.3-10.8 0.8-14.1 0.6-3.3 1.9-6.6 3.9-9.9 2-3.2 5.2-5.5 9.7-6.7 4.5-1.2 10.4-1.9 17.9-1.9h40.5V0h-64.8c-37.5 0-64.4 8.9-80.8 26.7 -16.4 17.8-24.6 44-24.6 78.7v48.8h-48.5v81.1h48.5v235.3h97.4V235.3h64.8l8.6-81.1H271.5z" fill="rgb(59, 89, 152)"></path></svg>';
            
            //var fblink = 'https://www.facebook.com/sharer/sharer.php?s=100&u=' +baseUrl + '&title='+ title //+'&description='+discrip+'&picture=http://www.losandes.com.ar/files/image/16/08/thumbs/image57a8952e9aee20.92964423.jpg';
            
            
            var fblink = 'https://www.facebook.com/sharer/sharer.php?u=http://iirmadev.com/&picture=&title=&description=Apparently%2C+the+accepted+answer+is+not+correct.';
            
            console.log(title)
            //https://www.facebook.com/sharer/sharer.php?s=100&u=http://10.132.150.2:8650/archived_events.html&title=test&description=test%20des&picture=http://www.losandes.com.ar/files/image/16/08/thumbs/image57a8952e9aee20.92964423.jpg
            //fblink += '?u=' + encodeURIComponent();
            //fblink += '&url=' + encodeURIComponent(opts.url);
