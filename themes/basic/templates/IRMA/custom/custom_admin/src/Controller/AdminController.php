...
class AdminController extends ControllerBase {
  ...
  */
  ...
  public function iirmaStudentsMess() {
    ...
    $query->fields('mess', ['name','batch_number','email','organisation','designation','country','city','state','arrival_date','arrival_time', 'departure_date', 'departure_time', 'purpose_of_visit','purpose', 'arrange_food', 'num_person']);
    $query->orderBy('date_created','DESC');
    $result = $query->execute();
    $htmlContent = "<table id='contactformdata'>
                     <tr>
